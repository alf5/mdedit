...
fn build_menu(app: &AppHandle) -> tauri::Result<Menu<tauri::Wry>> {
    ...
    let format_menu = Submenu::with_items(
        ...
        true,
        &[
            &MenuItem::with_id(app, "fmt_bold", "Bold", true, None::<&str>)?,
            &MenuItem::with_id(app, "fmt_italic", "Italic", true, None::<&str>)?,
            &MenuItem::with_id(app, "fmt_strike", "Strikethrough", true, None::<&str>)?,
            &MenuItem::with_id(app, "fmt_code", "Inline Code", true, None::<&str>)?,
            &PredefinedMenuItem::separator(app)?,
            &MenuItem::with_id(app, "fmt_h1", "Heading 1", true, None::<&str>)?,
            &MenuItem::with_id(app, "fmt_h2", "Heading 2", true, None::<&str>)?,
            &MenuItem::with_id(app, "fmt_h3", "Heading 3", true, None::<&str>)?,
            &MenuItem::with_id(app, "fmt_p", "Paragraph", true, None::<&str>)?,
            &PredefinedMenuItem::separator(app)?,
